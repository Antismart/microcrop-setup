...
import { CustomLineChart, CustomPieChart, CustomBarChart } from "@/components/charts"
...
export default function CooperativeDashboard() {
  ...
  const cooperativeName = (stats as any)?.cooperative?.name || "Your Cooperative"
  const cooperativeStatus = (stats as any)?.cooperative?.status
        ...
        <div className="flex items-center justify-between">
          <div>
            <div className="flex items-center space-x-3">
              <h1 className="text-3xl font-bold text-gray-900">{cooperativeName}</h1>
              {cooperativeStatus && (
                <Badge
                  variant={cooperativeStatus === "ACTIVE" ? "default" : "secondary"}
                  className={
